...
export default function LoadingScreen({ isLoading }: LoadingScreenProps) {
  useEffect(() => {
    ...
    if (bar && barLine && loadingScreen && upperHalf && lowerHalf) {
      ...
      loadingScreen.classList.add("scale-down");
  ...
  return (
    ...
    >
      ...
      <div className="bar-line absolute w-30 md:w-60 lg:w-80 h-1.5 rounded bg-gray-800 overflow-hidden z-2 top-[50vh] left-[50vw] transform: -translate-x-[50%] -translate-y-[50%]">
